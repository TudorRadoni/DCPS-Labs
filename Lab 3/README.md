...
## Exercise 2 – One Operational Component + One Backup (1oo2)
...
## Exercise 3 – One Operational Component + Two Backups (1oo3)

- **Increased redundancy** further improves reliability.
- **Diminishing returns** compared to Exercise 2 (as seen in the previous lab as well).

## Exercise 4 – k-out-of-n System (2oo3)

- **Stricter operational requirement:** At least two components must be operational.
- Reliability is **lower than in Exercise 3**, but higher than in simpler systems.
- Trades **fault tolerance for guaranteed performance capacity**.

## Exercise 5 – Series–Parallel System
